...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Override
    protected void doFilterInternal(HttpServlletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        log.log("Jwt필터 실행");
        ...
        try{
            ...
            if(userId != null) {
                ...
                //                         컨틀로러/서비스에서 꺼내 사용
                _____ authenicationToken
                        = _____ _____(userId, null, _____._____());
                _____._____()._____(authenicationToken);
            }else{
        ...
        // 9) 토큰 검증 완료 -> 다음 필터 또는 컨트롤러로 진행
         filterChain._____(request, response);
    }
}
